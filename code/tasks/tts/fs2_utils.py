...
from utils.durationjisuan import frame2phdur,collate_masks,collate_masks2,collate_masks3,collate_masks2qian0hou1,collate_masks3qian2hou1
...
class FastSpeechDataset(BaseDataset):
    ...
    def collater(self, samples):
        ...
        phduration=frame2phdur(mel2ph)
        attentionmaskjuzhen=collate_masks3(phduration)
        batch = {
            'id': id,
            ...
            'f0': f0,
            'uv': uv,
            'attentionmaskjuzhen': attentionmaskjuzhen,
        }
